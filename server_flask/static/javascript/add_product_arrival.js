...
$('#addButton').on('click', function() {
    ...
    var newField = $('<div>')
        ...
        '<div class="col-sm col-lg-2"><input type="number" style="text-align: center;" class="total form-control" id="total" name="total" min="1" placeholder="Сумма" required><br></div>'+
...
return result.text || result.text; // Виведення тексту товару
}
});
var scriptElement = document.createElement('script');
        scriptElement.type = 'module';
        scriptElement.src = "/static/javascript/add_product_arrival.js";
