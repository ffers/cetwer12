...
class ProductAnaliticControl():
    ...
    def all_product_analitic(self):
        all_item = an_rep.all_product_analitic()
        return all_item

    def add_product_analitic(self, product_id):
        prod_item = an_rep.search_an_product_id(product_id)
        if not prod_item:
            an_rep.add_product_analitic(product_id)
            return True
        return False
    ...
    def update_product_analitic(self, product_id):
        ...
        resp_bool = an_rep.update_product_analitic(
            product_id,
            sum_money,
            sum_quantity_sale,
            money_in_sale
