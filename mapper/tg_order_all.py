...
class TextOrderAllInfo:
    ...
    def builder(self):
        ...
        self.tx_bl.create_date = self.create_date(self.order)
        ...
        self.tx_bl.history = self.history(self.order)
    ...
    def create_date(self, order):
        return f"{order.timestamp.strftime('%d-%m-%Y %H:%M')}\n"
